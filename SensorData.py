...
class RGBDFrame():
    ...
    def load(self, file_handle):
        ...
        # image_string = open('C:\\scan\\BundleFusion-master\\data\\out\\color\\0.jpg', 'rb').read()
        #
        # base = imageio.imread(self.color_data)
        # load = imageio.imread(image_string)
        # imageio.imwrite(os.path.join('C:\\qqq', str("base") + '.jpg'), base)
        # imageio.imwrite(os.path.join('C:\\qqq', str("load") + '.jpg'), load)
        #
        # if self.color_data == image_string:
        #     print("d")
        # print("d")
